            ...
            <form action="" className="mx-auto mb-0 mt-8 max-w-md space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    type="email"
                    className="w-full rounded-lg border-solid border-2 border-gray-200 p-4 pe-12 text-sm shadow-sm"
                  />
              ...
              <div className="flex items-center justify-between">
                <p className="mt-4 text-base text-gray-500 sm:mt-0">
                  No account?
                  <a className="text-gray-700 underline m-2" href="/auth/signup">
                    Sign up
                  </a>
                </p>
                ...
                <button
                  type="submit"
                  className="inline-block rounded-lg bg-blue-500 px-5 py-3 text-base font-medium text-white"
                >
                  Log in
                </button>
              </div>
